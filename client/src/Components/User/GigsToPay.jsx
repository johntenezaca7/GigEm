...
class GigsToPay extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
export default connect(mapStateToProps, mapDispatchToProps)(GigsToPay);

<img width="20%" height="20%" src="https://www.paypalobjects.com/webstatic/en_US/i/buttons/checkout-logo-large.png" alt="Check out with PayPal" />